...
const std::vector<Opcode> opcodes = {
    ...
    {0x1C, "NOP", AddressingMode::AbsoluteX, 3, 4, kIllegalOpcode},
    ...
    {0x3C, "NOP", AddressingMode::AbsoluteX, 3, 4, kIllegalOpcode},
    ...
    {0x5C, "NOP", AddressingMode::AbsoluteX, 3, 4, kIllegalOpcode},
    ...
    {0x7C, "NOP", AddressingMode::AbsoluteX, 3, 4, kIllegalOpcode},
    ...
    {0xB2, "SHA", AddressingMode::Immediate, 1, 0,
     kIllegalOpcode& kUnstableOpcode},
    {0xB3, "LAX", AddressingMode::IndirectY, 2, 5, kIllegalOpcode},
    ...
    {0xBF, "LAX", AddressingMode::AbsoluteY, 3, 4, kIllegalOpcode},
    ...
    {0xDC, "NOP", AddressingMode::AbsoluteX, 3, 4, kIllegalOpcode},
    ...
    {0xFC, "NOP", AddressingMode::AbsoluteX, 3, 4, kIllegalOpcode},
